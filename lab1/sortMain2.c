...
main(int argc, char * argv[])
{
	...
	/*Check if there are any commandline arguments. If not, then run the default operation with the hardcoded values.*/
	...
	if(argc > 1)
	{
		...
		{
			data[counter - 1] = atoi(argv[counter]); 
		}
		
	}
	else
	{
		/*There are no commandline arguments. Run the default program*/
		/* Test data */
		nDataItems = 4;
