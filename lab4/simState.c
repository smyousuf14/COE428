	...
	/*Local Variable list*/
	  ...
	  while(end == 0)
	  {
	      ...
	      if(inputs[0] == 'g')
	      {
	          ...
	          int reachable[7] = {0,0,0,0,0,0,0,0}; /*These will represent the reachable states*/
